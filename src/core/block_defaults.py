...
BLOCK_LABELS: dict[tuple[str, str], str] = {
    ...
    ("site", "footer_link_privacy"): "Посилання privacy",
    ("site", "footer_copyright"): "Copyright назва",
    ("site", "footer_credit"): "Кредит розробника",
    ...
    ("contacts", "label_phone"): "Мітка телефон",
    ("contacts", "label_email"): "Мітка email",
    ("contacts", "label_address"): "Мітка адреса",
}
