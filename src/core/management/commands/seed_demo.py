...
INFO_PAGES = [
    (
        ...
        "Про нас",
        "О нас",
        "«Квест-марафон» — лінійний онлайн-квест із п’яти кімнат. Після реєстрації та оплати ви проходите завдання строго по черзі: від першої кімнати до п’ятої. У кожній кімнаті — своя загадка; відповідь — одне ключове слово. Прогрес зберігається: можна вийти і повернутись у будь-який момент.",
        "«Квест-марафон» — линейный онлайн-квест из пяти комнат. После регистрации и оплаты вы проходите задания строго по порядку: от первой комнаты к пятой. В каждой комнате — своя загадка; ответ — одно ключевое слово. Прогресс сохраняется: можно выйти и вернуться в любой момент.",
    ),
    (
        "faq",
        "FAQ",
